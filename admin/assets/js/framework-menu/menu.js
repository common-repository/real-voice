	...
	function ($) {
		...
		$( document.body ).on(
			...
			function () {
				...
				$( '.daextrevo-main-form__daext-form-section-body[data-section-id="' + target + '"]' ).toggleClass( 'daextrevo-main-form__daext-form-section-body-opened' );
		...
		$( document.body ).on(
			'mouseenter',
			'.daextrevo-admin-toolbar__menu-item-more',
			function () {
				$( '.daextrevo-admin-toolbar__pop-sub-menu' ).show();
			}
		);

		$( document.body ).on(
			'mouseleave',
			'.daextrevo-admin-toolbar__menu-item-more, .daextrevo-admin-toolbar__pop-sub-menu',
			function () {
				$( '.daextrevo-admin-toolbar__pop-sub-menu' ).hide();
			}
		);
		...
		$( document ).on(
			'change',
			'.daextrevo-bulk-action-checkbox',
			function () {
				let selectedItems = [];
				$( '.daextrevo-bulk-action-checkbox:checked' ).each(
					function () {
