...
class Daextrevo_Pagination {
	 ...
	 * Constructor.
	 *
	 * @param Daextrevo_Shared $shared Instance of the shared class.
	 */
	...
	public function show() {
		...
		if ( $last_page > 1 ) {
			...
			echo '<div class="daextrevo-crud-table-controls__pagination-paging-text">' .
